...
class PostRetrieveUpdateDestoryView(generics.RetrieveUpdateDestoryAPIView):
        ...
        return Response(
            {
                ...
                "message":"post muvofaqiyatli o'zgartirildi",
...
class PostLikeApiView(APIView):
    ...
    def post(self,request,pk):
        try:
            ...
            data = {
                "success":True,
                "message":"Like Muvofaqiyatli o'chirildi"
            }
