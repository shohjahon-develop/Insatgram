...
class PostSerializer(serializers.ModelSerializer):
    ...
    me_liked = serializers.SerializerMethodField('get_me-liked')
    ...
    def get_me_liked(self,obj):
        requests = self.context.get('request',None)
        if requests and requests.user.is_authenticated:
            try:
                like = PostLike.objects.get(post=obj, author=requests.user)
                return True
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    me_liked = serializers.SerializerMethodField('get_liked')
